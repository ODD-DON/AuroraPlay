...
DialogView {
    ...
    Item {
        RowLayout {
            ...
            Label { text: qsTr("Placebo Renderer Settings"); font.pixelSize: 18 }
            Item { Layout.fillWidth: true }
            Button { text: qsTr("Help"); onClicked: { options_url = Chiaki.openPlaceboOptionsLink() }; Material.roundedScale: Material.SmallScale }
        }
