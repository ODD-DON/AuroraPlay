        ...
        Item {
            ...
            ToolBar {
                ...
                RowLayout {
                    ...
                    Label { text: title; font.pixelSize: 18 }
                    Item { Layout.fillWidth: true }
                    Button { id: reloadButton; text: qsTr("Reload"); onClicked: reloadTimer.start(); Material.roundedScale: Material.SmallScale }
                    ProgressBar { id: browserProgresss; Layout.preferredWidth: 220; from: 0; to: 100; value: webView.web ? webView.web.loadProgress : 0; Material.roundedScale: Material.SmallScale }
                    Button {
                        id: extBrowserButton
